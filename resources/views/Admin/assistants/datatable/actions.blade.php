<a href="{{ route('assistants.edit',$user->id) }}" class="btn btn-info btn-sm">   Edit</a>
<button type="button" class="btn btn-btn btn-danger btn-sm " data-toggle="modal" data-target="#delete{{ $user->id }}">
    <i class="fa fa-trash"></i>
    Delete
</button>
<form action="{{ route('assistants.destroy', $user->id) }}" class="my-1 my-xl-0" method="post" style="display: inline-block;" autocomplete="off">
    @csrf
    @method('delete')
