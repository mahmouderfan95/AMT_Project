            ...
            <div class="content-header row">
                ...
                <div class="content-header-right col-md-6 col-12">
                    <div class="btn-group float-md-right">
                        <a href="{{ route('courses.create') }}" class="btn btn-primary btn-sm mb-3">
                            Add New Course
                        </a>
                    </div>
                </div>
    ...
    <script>
        let catsTable = $('#students-table').DataTable({
            ...
            columns: [
                ...
                {data: 'user_id', name: 'user_id', searchable: true,sortable: true,orderable: true},
                {data: 'level', name: 'level', searchable: false, sortable: false, width: '10%'},
                {data: 'category', name: 'category', sortable: true, width: '10%'},
